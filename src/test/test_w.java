...
public class test_w {
    ...
    public void testNoWord1AndWord2InGraph() {
        // 路径1: 1 -> 2
        String result = queryBridgeWords(graph, "nonexistent1", "nonexistent2");
    ...
    public void testNoWord1InGraph() {
        // 路径2: 1 -> 3 -> 4
        String result = queryBridgeWords(graph, "nonexistent1", "to");
    ...
    public void testNoWord2InGraph() {
        // 路径3: 1 -> 3 -> 5 -> 6
        String result = queryBridgeWords(graph, "to", "nonexistent2");
        assertEquals("No nonexistent2 in the graph!", result);
    }
